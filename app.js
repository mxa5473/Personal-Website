...
function convLocalLink(link, country, type) {
    if (country === "US" || (country !== "US" && country !== "CA")) {
        if (type === "2415") {
            link = "https://www.amazon.com/Canon-24-105mm-USM-Zoom-Lens/dp/B000B84KAW/ref=sr_1_3?ie=UTF8&qid=1518289159&sr=8-3&tag=mustafaalnuaimy";
        }
        else {
            link = link.replace("www.amazon.ca", "www.amazon.com");
            link = link.replace("tag=mustafaalnuaimy", "tag=mustafaalnuaimy");
        }
    }
    return link;
}
